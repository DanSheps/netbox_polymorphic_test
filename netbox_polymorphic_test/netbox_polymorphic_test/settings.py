...
config_path = os.getenv('NETBOX_CONFIGURATION', 'netbox_polymorphic_test.configuration')
try:
...
ROOT_URLCONF = 'netbox_polymorphic_test.urls'
...
# WSGI
WSGI_APPLICATION = 'netbox_polymorphic_test.wsgi.application'
